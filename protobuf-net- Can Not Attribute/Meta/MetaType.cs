...
namespace ProtoBuf.Meta
{
    ...
    public class MetaType : ISerializerProxy
    {
        ...
        internal void ApplyDefaultBehaviour()
        {
            ...
            foreach (MemberInfo member in foundList)
            {
                ...
                if((property = member as PropertyInfo) != null)
                {
                    ...
                    ApplyDefaultBehaviour_AddMembers(-1, model, family, isEnum, partialMembers, dataMemberOffset, inferTagByName, implicitMode, members, member, ref forced, isPublic, isField, ref effectiveType);
                }
        ...
        private static void ApplyDefaultBehaviour_AddMembers(int Id,TypeModel model, AttributeFamily family, bool isEnum, BasicList partialMembers, int dataMemberOffset, bool inferTagByName, ImplicitFields implicitMode, BasicList members, MemberInfo member, ref bool forced, bool isPublic, bool isField, ref Type effectiveType)
        {
            ...
            {
                ProtoMemberAttribute normalizedAttribute = NormalizeProtoMember(Id,model, member, family, forced, isEnum, partialMembers, dataMemberOffset, inferTagByName);
      ...
      internal static AttributeFamily GetContractFamily(RuntimeTypeModel model, Type type, AttributeMap[] attributes)
        ...
        private static ProtoMemberAttribute NormalizeProtoMember(int Id,TypeModel model, MemberInfo member, AttributeFamily family, bool forced, bool isEnum, BasicList partialMembers, int dataMemberOffset, bool inferByTagName)
        {
