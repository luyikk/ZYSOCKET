...
namespace ZYSocket.MicroThreading
{
    ...
    public class Scheduler
    {
        ...
        public Scheduler()
        {
            ...
            FrameChannel = new Channel { Preference = ChannelPreference.PreferSender };
        }
        ...
        public Channel FrameChannel { get; }
        ...
        public void Run()
        {
#if SILICONSTUDIO_PLATFORM_UWP || COREFX
            ...
            while (FrameChannel.Balance<int>() < 0)
                FrameChannel.Set(0);
        }
        ...
        public PriorityQueueNode<SchedulerEntry> Create(Action simpleAction, int priority)
        {
