...
namespace RPCTalkServer
{
    ...
    public class TalkServer:RPCCallObject
    {
        ...
        public bool LogOn(string userName,string passWord)
        {
            ...
            {
                UserList[userName].RPCSession.Disconnect();
        ...
        private void SendUpdateUserlist()
        {
            ...
            {
                item.RPCSession.GetRPC<IClient>().UpdateUserList();
            }
        }
        ...
        public void SendAllMessage(string msg)
        {
            ...
            foreach (var item in UserList.Values)
            {
                 ...
                 item.RPCSession.GetRPC<IClient>().MessageShow(user.UserName + ":" + msg);
        ...
        public void SendToMessage(string username, string msg)
        {
            ...
            if (userinfo != null)
                userinfo.RPCSession.GetRPC<IClient>().MessageShow(user.UserName + " 对你说:" + msg);
        }
