...
namespace ZYSocket.ZYNet.Client
{
    ...
    internal class SocketClient
    {
        ...
        public SocketError socketError { get { return _socketError; } }
        ...
        public bool Connect(string host, int port)
        {
            ...
            catch (SocketException er)
            {
                ...
                _socketError = er.SocketErrorCode;
        ...
        void BeginReceive()
        {
            try
            {
                ...
                IAsyncResult reault = sock.BeginReceive(data, 0, data.Length, SocketFlags.None, out _socketError, args_Completed, data);
